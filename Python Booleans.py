...
Evaluate Values and VariablesThe bool() function allows you to evaluate any value, and give
...
Some Values are FalseIn fact, there are not many values that evaluate to False, except empty
...
You can execute code based on the Boolean answer of a function:Example
