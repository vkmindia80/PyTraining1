...
'''
# Note: Backslash in the path should be changed to double slash. 
# # From C:\Users\Siri\Desktop\test to C:\\Users\\Siri\\Desktop\\test\\
'''
f = open("C:\\Users\\Siri\\Desktop\\test\\welcome.txt", "r")
print(f.read())
...
f = open("demofile.txt", "r")
print(f.read(5)) #first 5 characters of the file
...
ExampleOpen the file "demofile2.txt" and append content to the file:
...
"a" - Append - will create a file if the specified file does not exists"w" - Write - will create a file if the specified file does not exists
Example
...
Example
'''
with open("demofile2.txt", "r") as file1:
    content = file1.read()
print(content)
