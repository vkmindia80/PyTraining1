...
documentations.Arbitrary Keyword Arguments, **kwargs
...
# Storing the returned result in a variable
output = my_function(10,20) # Calling the function with arguments
...
A global variable is defined at the top-level of your script, outside any
function. It is accessible from anywhere in your code, including inside
functions.
...
2. Local Variables
A local variable is defined inside a function. It only exists while that function
is running and cannot be accessed from the outside.

def myfunc():
    y = "fantastic" # Local variable
    print("Inside:", y)
myfunc()
print(y) # This would cause a NameError. NameError: name 'y' is not defined

3. global keyword
'''
amt = 300
def myfunc():
    global amt # Declaring 'amt' as global to modify it
    # Declaring 'amt' as global to modify it
    amt = 400
    print("Inside:", amt)
myfunc()
print("Outside:", amt) # 200
